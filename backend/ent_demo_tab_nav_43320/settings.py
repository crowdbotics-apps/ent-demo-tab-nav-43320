"""
Django settings for ent_demo_tab_nav_43320 project.
...
ROOT_URLCONF = 'ent_demo_tab_nav_43320.urls'
...
WSGI_APPLICATION = 'ent_demo_tab_nav_43320.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ent_demo_tab_nav_43320 API",
    "DESCRIPTION": "API documentation for ent_demo_tab_nav_43320 App",
    "VERSION": "v1",
}
